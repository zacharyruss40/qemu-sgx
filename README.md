...
Releases
========
  * sgx-v5.1.0-rc3(The candidate qemu-sgx release for internal/external usage)
      ...
      - Set SGX_LEPUBKEYHASH MSR to default value for one windows sgx bug.
      - Support sgx epc section reset function when guest reboot. This fix
        windows2019 reboot panic issue.
      - Fix keymaps install issue.
